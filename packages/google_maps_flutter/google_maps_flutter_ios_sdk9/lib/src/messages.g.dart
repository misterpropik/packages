...
class PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets {
  PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets({
    required this.bounds,
    required this.padding,
  });
  ...
  static PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets decode(Object result) {
    result as List<Object?>;
    return PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets(
      bounds: result[0]! as PlatformLatLngBounds,
      padding: result[1]! as PlatformEdgeInsets,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(139);
      writeValue(buffer, value.encode());
    }    else if (value is PlatformCameraUpdateNewLatLngBoundsWithEdgeInsets) {
      buffer.putUint8(140);
      writeValue(buffer, value.encode());
