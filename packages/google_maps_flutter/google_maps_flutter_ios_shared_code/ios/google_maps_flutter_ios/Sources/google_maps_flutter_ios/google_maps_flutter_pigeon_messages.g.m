...
@interface FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets ()
+ (FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets *)fromList:(NSArray<id> *)list;
+ (nullable FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets
+ (instancetype)makeWithBounds:(FGMPlatformLatLngBounds *)bounds
    padding:(FGMPlatformEdgeInsets *)padding {
  FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets* pigeonResult = [[FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets alloc] init];
  pigeonResult.bounds = bounds;
  pigeonResult.padding = padding;
  return pigeonResult;
}
...
+ (nullable FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.bounds ?: [NSNull null],
...
- (BOOL)isEqual:(id)object {
  ...
  FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets *other = (FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets *)object;
  return FLTPigeonDeepEquals(self.bounds, other.bounds) && FLTPigeonDeepEquals(self.padding, other.padding);
}
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 140: 
      return [FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets fromList:[self readValue]];
    case 141: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FGMPlatformMapTypeBox class]]) {
    ...
    [self writeByte:139];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FGMPlatformCameraUpdateNewLatLngBoundsWithEdgeInsets class]]) {
    [self writeByte:140];
    [self writeValue:[value toList]];
